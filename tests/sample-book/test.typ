#import "../../lib.typ": orange-book, cover, copyright-page, toc-pages, main-pages, part, chapter, my-bibliography, appendices, make-index, index, theorem, definition, notation,remark,corollary,proposition,example,exercise, problem, vocabulary, mathcal, update-heading-image
...
#cover(
  ...
  author: "Goro Akechi",
  cover-image: image("./background.png"),
)
